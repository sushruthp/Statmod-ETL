...
#local replica
#mysql -u$statmod_uname -p$statmod_pwd -B -e "\. ~/statmod/toroParamOffers.sql"

#product analytics_db
mysql -h$analytics_db_host -u$analytics_uname -p$analytics_pwd -B -e "\. ~/statmod/toroParamOffers.sql"
